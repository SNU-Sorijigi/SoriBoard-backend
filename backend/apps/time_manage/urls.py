...
from .views import UserViewSet, SemesterInfoViewSet, TimeInfoViewSet, MusicInfoViewSet, PlayerInfoViewSet, ComposerInfoViewSet, ConductorInfoViewSet, OrchestraInfoViewSet, SemesterUserInfoViewSet, SemesterUserInfoPostViewSet, SemesterInfoPostViewSet
